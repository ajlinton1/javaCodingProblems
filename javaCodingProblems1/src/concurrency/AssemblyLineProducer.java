...
public class AssemblyLineProducer {
    ...
    private static AssemblyLineProducer.Consumer consumer;
    private static AssemblyLineProducer.Producer producer;
    private static final Queue<String> queue = new ConcurrentLinkedQueue<>();

    private AssemblyLineProducer() {
    ...
    public static void startAssemblyLine() {
        ...
        producer = new AssemblyLineProducer.Producer();
        producerService.execute(producer);

        runningConsumer = true;
        consumerService = Executors.newSingleThreadExecutor();
        consumer = new AssemblyLineProducer.Consumer();
